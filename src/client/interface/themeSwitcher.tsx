...
export default class ThemeSwitcher extends React.Component {
	...
	render() {
		...
		flex-wrap
		justify-content-center position-absolute w-100 h-100 align-items-center
		align-content-center">
			...
			<div className="btn-group">
				...
				<div className="dropdown-menu">
					...
					<a className="dropdown-item" onClick={e => this.chooseTheme( 'Primary', e )}>
						Primary Theme
					</a>
					<a className="dropdown-item" onClick={e => this.chooseTheme( 'Danger', e )}>
						Danger Theme
					</a>
					<a className="dropdown-item" onClick={e => this.chooseTheme( 'Success', e )}>
						Success Theme
					</a>
